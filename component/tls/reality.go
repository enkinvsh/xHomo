...
func GetRealityConn(ctx context.Context, conn net.Conn, fingerprint UClientHelloID, clientFingerprint string, serverName string, realityConfig *RealityConfig) (net.Conn, error) {
	for retry := 0; ; retry++ {
